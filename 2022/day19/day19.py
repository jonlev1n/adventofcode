...
def optimize_factory(
    ...
    max_materials_necessary[3] = float(
        "inf"
    )  # we need as many geodes opened as possible
...
ans1 = solve_a()
ans2 = solve_b()
submit(ans1, day=19, year=2022, part="a")
submit(ans2, day=19, year=2022, part="b")
