...
Cuboid = namedtuple(
    "Cuboid", ["min_x", "max_x", "min_y", "max_y", "min_z", "max_z", "sign"]
)
...
def solve_part_2(instructions):
    ...
    for state, x_range, y_range, z_range in instructions:
        ...
        curr = Cuboid(
            min_x, max_x, min_y, max_y, min_z, max_z, -1 if state == "off" else 1
        )
        intersections = []
...
if __name__ == "__main__":
    with open("/Users/jon/git/adventofcode2021/day22/day22.txt") as f:
        instructions = []
